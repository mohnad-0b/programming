...
public class Sekai
{
    ...
    public static String encrypt(final char[] array, final int n) {
        ...
        int n2 = Sekai.length - 1; // 5
        int length = Sekai.length; // 6
    ...
    public static boolean solve(final String s) {
        ...
        return "oz]{R]3l]]B#50es6O4tL23Etr3c10_F4TD2".equals(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;) /lang/String;, encrypt(getArray(transform, 0, 5), 2), encrypt(getArray(transform, 1, 4), 1), encrypt(getArray(transform, 2, 3), 0)));
    }
